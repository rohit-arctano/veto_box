...
#ifndef FAST_DDS_GENERATED__TESTAPPLICATION_HPP
#define FAST_DDS_GENERATED__TESTAPPLICATION_HPP
...
public:
    ...
    static std::shared_ptr<TestApplication> make_app(
            const int& domain_id,
            const std::string& entity_kind);
};

#endif // FAST_DDS_GENERATED__TESTAPPLICATION_HPP